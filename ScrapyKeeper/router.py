...
from ScrapyKeeper.controller.ElkLogCtrl import ElkLogCtrl
...
from ScrapyKeeper.controller.ScrapydLogCtrl import ScrapydLogCtrl
...
def regist_router():
    restful_api.add_resource(ElkLogCtrl, '/log_manage/error')
    ...
    restful_api.add_resource(ScrapydLogCtrl, "/original_log")
    ...
    restful_api.add_resource(StartUrlsCtrl, "/start")
