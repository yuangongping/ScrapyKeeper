# -*- coding: utf-8 -*-
BOT_NAME = 'renminwang_master'

SPIDER_MODULES = ['renminwang_master.spiders']
NEWSPIDER_MODULE = 'renminwang_master.spiders'
...
ITEM_PIPELINES = {
   'renminwang_master.pipelines.RenminwangMasterPipeline': 300,
}
