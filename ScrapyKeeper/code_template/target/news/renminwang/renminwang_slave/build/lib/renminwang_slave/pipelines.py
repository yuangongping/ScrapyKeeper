...
import redis
import json
from .items import RenminwangSlaveDetailItem
...
class RenminwangSlaveItemPipeline(object):
    def __init__(self, redis_host, redis_port):
        self.redis_host = redis_host
        self.redis_port = redis_port
        self.redis_name = "renminwang"
    ...
    def process_item(self, item, spider):
        ...
        try:
            ...
            if isinstance(item, RenminwangSlaveDetailItem):
                obj = Content()
