...
import redis
import json
from .items import CeershiSlaveDetailItem
...
class CeershiSlavePipeline(object):
    def __init__(self, redis_host, redis_port):
        self.redis_host = redis_host
        self.redis_port = redis_port
        self.redis_name = "ceershi"
    ...
    def process_item(self, item, spider):
        ...
        try:
            ...
            if isinstance(item, CeershiSlaveDetailItem):
                obj = Content()
