...
class BaidushouyeceshiMasterProxyMiddleware(object):
    """换代理IP"""
...
class BaidushouyeceshiMasterSpiderMiddleware(object):
    @classmethod
...
class BaidushouyeceshiMasterDownloaderMiddleware(object):
