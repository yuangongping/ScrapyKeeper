...
import redis
import json
from .items import BaidushouyeceshiSlaveDetailItem
...
class BaidushouyeceshiSlavePipeline(object):
    def __init__(self, redis_host, redis_port):
        self.redis_host = redis_host
        self.redis_port = redis_port
        self.redis_name = "baidushouyeceshi"
        self.crawl_num = 0
    ...
    def process_item(self, item, spider):
        ...
        try:
            ...
            if isinstance(item, BaidushouyeceshiSlaveDetailItem):
                obj = Content()
            ...
            if self.crawl_num == 50:
                requests.post("172.16.119.6:5060/data_storage", data={
                    "project_name": "",
                    "project_alias": "",
                    "num": "",
                    "file_size": "",
