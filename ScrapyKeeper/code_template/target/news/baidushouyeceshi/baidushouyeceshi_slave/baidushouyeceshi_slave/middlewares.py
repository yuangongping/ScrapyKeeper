...
class BaidushouyeceshiSlaveProxyMiddleware(object):
    """换代理IP"""
...
class BaidushouyeceshiSlaveSpiderMiddleware(object):
    @classmethod
...
class BaidushouyeceshiSlaveDownloaderMiddleware(object):
    @classmethod
    def from_crawler(cls, crawler):
        s = cls()
        crawler.signals.connect(s.spider_opened, signal=signals.spider_opened)
