...
class BaidushouyeceshiSlaveSlaveSpider(RedisSpider):
    name = "baidushouyeceshi_slave_spider"
    redis_key = "baidushouyeceshi"
    session = session
    ...
    def parse(self, response):
        ...
        detailItem = BaidushouyeceshiSlaveDetailItem()
        ...
        for href in all_a:
            ...
            if 'http' in href:
                item = BaidushouyeceshiSlaveItem()
                item['url'] = href
                yield item
