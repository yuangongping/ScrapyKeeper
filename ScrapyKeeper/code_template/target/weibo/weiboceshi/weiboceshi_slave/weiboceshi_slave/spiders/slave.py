...
class WeiboceshiSlaveSpider(RedisSpider):
    name = "weiboceshi_slave_spider"
    redis_key = "weiboceshi"
    headers = {
        ...
        try:
            ...
            if img:
                ...
                if uuid:
                    file_group_uuids.append(uuid)
            """    *************提取帖子的信息模块****************     """
            contentItem = WeiboceshiSlavePostItem()
    ...
    def parse_comment(self, response):
        ...
        for cmt in comments:
            commentItem = WeiboceshiSlaveCommentItem()
