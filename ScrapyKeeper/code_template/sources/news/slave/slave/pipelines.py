...
import redis
import json
from .items import {{project_name_capitalize}}DetailItem
...
class {{project_name_capitalize}}Pipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        try:
            ...
            if isinstance(item, {{project_name_capitalize}}DetailItem):
                obj = Content()
